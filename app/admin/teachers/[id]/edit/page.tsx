...
async function updateTeacher(id: string, formData: FormData) {
  "use server";
...
export default async function EditTeacherPage({
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-black">Edit Teacher</h1>
      <TeacherForm action={updateTeacher.bind(null, id)} defaults={teacher} />
    </div>
  );
}
